			...
			<!-- ================ -->
			<div class="banner">
				<div class="fixed-image section light-translucent-bg" style="background-image:url('static/images/page-about-banner-2.jpg');">
					<div class="container">
									...
									<div class="panel-heading">
										<h4 class="panel-title">
											<a data-toggle="collapse" data-parent="#accordion" href="#collapseFourth" class="collapsed">
												<i class="fa fa-life-saver"></i>24/7 Top Notch Support
											</a>
										</h4>
									</div>
						...
						<div class="col-md-6">
							<div class="owl-carousel content-slider-with-controls">
								<div class="overlay-container margin-top-clear">
									<img src="static/images/page-about-2.jpg" alt="">
									<a href="static/images/page-about-2.jpg" class="popup-img overlay" title="image title"><i class="fa fa-search-plus"></i></a>
								</div>
								<div class="overlay-container margin-top-clear">
									<img src="static/images/page-about-1.jpg" alt="">
									<a href="static/images/page-about-1.jpg" class="popup-img overlay" title="image title"><i class="fa fa-search-plus"></i></a>
								</div>
								<div class="overlay-container margin-top-clear">
									<img src="static/images/page-about-3.jpg" alt="">
									<a href="static/images/page-about-3.jpg" class="popup-img overlay" title="image title"><i class="fa fa-search-plus"></i></a>
								</div>
							</div>
						</div>
					</div>
			...
			<div class="section gray-bg clearfix">
				<div class="container">
					<h2 class="title">Stats &amp; Skills</h2>
					<div class="separator-2"></div>
					<p class="lead">Lorem ipsum dolor sit amet, consectetur adipisicing elit. <br> Perferendis tenetur beatae adipisci atque.</p>
					<div class="row">
						<div class="col-md-6">
					...
					<div class="row grid-space-20">
						<div class="col-md-3 col-sm-6">
							<div class="box-style-1 gray-bg team-member">
								<div class="overlay-container">
									<img src="static/images/team-member-1.jpg" alt="">
									<div class="overlay">
						...
						<div class="col-md-3 col-sm-6">
							<div class="box-style-1 gray-bg team-member">
								<div class="overlay-container">
									<img src="static/images/team-member-2.jpg" alt="">
									<div class="overlay">
										<ul class="social-links light clearfix">
											<li class="twitter"><a target="_blank" href="http://www.twitter.com"><i class="fa fa-twitter"></i></a></li>
											<li class="skype"><a target="_blank" href="http://www.skype.com"><i class="fa fa-skype"></i></a></li>
						...
						<div class="col-md-3 col-sm-6">
							<div class="box-style-1 gray-bg team-member">
								<div class="overlay-container">
									<img src="static/images/team-member-3.jpg" alt="">
									<div class="overlay">
										<ul class="social-links light clearfix">
											<li class="twitter"><a target="_blank" href="http://www.twitter.com"><i class="fa fa-twitter"></i></a></li>
											<li class="skype"><a target="_blank" href="http://www.skype.com"><i class="fa fa-skype"></i></a></li>
						...
						<div class="col-md-3 col-sm-6">
							<div class="box-style-1 gray-bg team-member">
								<div class="overlay-container">
									<img src="static/images/team-member-4.jpg" alt="">
									<div class="overlay">
										<ul class="social-links light clearfix">
											<li class="twitter"><a target="_blank" href="http://www.twitter.com"><i class="fa fa-twitter"></i></a></li>
											<li class="skype"><a target="_blank" href="http://www.skype.com"><i class="fa fa-skype"></i></a></li>
