						...
						<div class="slider-banner">
							<ul>
								...
								<li data-transition="random" data-slotamount="7" data-masterspeed="500" data-saveperformance="on" data-title="Premium HTML5 template">
									...
									<!-- main image -->
									<img src="static/images/slider/slider-01.jpg"  alt="slidebg1" data-bgposition="center top" data-bgfit="cover" data-bgrepeat="no-repeat">
									...
									<div class="tp-caption sfr tp-resizeme"
										...
										data-start="2700"
										data-end="9400"
										data-endspeed="600"><img src="static/images/slider/slider-1-layer-1.png" alt="">
									</div>
								...
								<li data-transition="random" data-slotamount="7" data-masterspeed="500" data-saveperformance="on" data-title="Powerful Bootstrap Theme">
									...
									<!-- main image -->
									<img src="static/images/slider/slider-02.jpg"  alt="slidebg1" data-bgposition="center top" data-bgfit="cover" data-bgrepeat="no-repeat">
									...
									<div class="tp-caption sfr tp-resizeme"
										...
										data-start="2700"
										data-end="9400"
										data-endspeed="600"><img src="static/images/slider/slider-1-layer-2.png" alt="">
									</div>
								...
								<li data-transition="random" data-slotamount="7" data-masterspeed="500" data-saveperformance="on" data-title="Powerful Bootstrap Theme">
									...
									<!-- main image -->
									<img src="static/images/slider/slider-03.jpg"  alt="kenburns"  data-bgposition="left center" data-kenburns="on" data-duration="10000" data-ease="Linear.easeNone" data-bgfit="100" data-bgfitend="115" data-bgpositionend="right center">
						...
						<div class="col-md-12">
							...
							<div class="row">
								<div class="col-md-6">
									...
									<div class="row">
										<div class="col-md-6">
											<img src="static/images/section-image-2.png" alt="">
										</div>
										<div class="col-md-6">
						...
						<div class="col-md-12">
							...
							<div class="vertical hc-tabs">
								...
								<div class="hc-tabs-top">
									<img data-tab="#tab1" src="static/images/section-image-1.png" alt="iDea" data-tab-animation-effect="fadeInRightSmall">
									<img data-tab="#tab2" src="static/images/section-image-2.png" alt="iDea" data-tab-animation-effect="fadeInRightSmall">
									<img data-tab="#tab3" src="static/images/section-image-3.png" alt="iDea" data-tab-animation-effect="fadeInRightSmall">
									<img data-tab="#tab4" src="static/images/section-image-4.png" alt="iDea" data-tab-animation-effect="fadeInRightSmall">
									<div class="space"></div>
								</div>
							...
							<div class="row">
								<div class="col-md-8 col-md-offset-2">
									...
									<div class="testimonial-image">
										<img src="static/images/testimonial-1.jpg" alt="Jane Doe" title="Jane Doe" class="img-circle">
									</div>
						...
						<div class="container">
							<div class="row">
								<div class="col-md-8 col-md-offset-2">
									...
									<div class="testimonial-image">
										<img src="static/images/testimonial-2.jpg" alt="Jane Doe" title="Jane Doe" class="img-circle">
									</div>
									<div class="testimonial-body">
						...
						<div class="container">
							<div class="row">
								<div class="col-md-8 col-md-offset-2">
									...
									<div class="testimonial-image">
										<img src="static/images/testimonial-3.jpg" alt="Jane Doe" title="Jane Doe" class="img-circle">
									</div>
									<div class="testimonial-body">
									...
									<div class="overlay-container">
										...
										<div class="overlay">
											<div class="overlay-links">
												...
												<a href="static/images/portfolio-1.jpg" class="popup-img"><i class="fa fa-search-plus"></i></a>
											</div>
										</div>
									</div>
								...
								<div class="image-box object-non-visible" data-animation-effect="fadeInLeft" data-effect-delay="200">
									<div class="overlay-container">
										...
										<div class="overlay">
											<div class="overlay-links">
												<a href="portfolio-item.html"><i class="fa fa-link"></i></a>
												<a href="static/images/portfolio-2.jpg" class="popup-img"><i class="fa fa-search-plus"></i></a>
											</div>
										</div>
									</div>
									<div class="image-box-body">
								...
								<div class="image-box object-non-visible" data-animation-effect="fadeInLeft" data-effect-delay="100">
									<div class="overlay-container">
										...
										<div class="overlay">
											<div class="overlay-links">
												<a href="portfolio-item.html"><i class="fa fa-link"></i></a>
												<a href="static/images/portfolio-3.jpg" class="popup-img"><i class="fa fa-search-plus"></i></a>
											</div>
										</div>
									</div>
									<div class="image-box-body">
								...
								<div class="image-box object-non-visible" data-animation-effect="fadeInLeft" data-effect-delay="0">
									<div class="overlay-container">
										...
										<div class="overlay">
											<div class="overlay-links">
												<a href="portfolio-item.html"><i class="fa fa-link"></i></a>
												<a href="static/images/portfolio-4.jpg" class="popup-img"><i class="fa fa-search-plus"></i></a>
											</div>
										</div>
									</div>
									<div class="image-box-body">
								...
								<div class="image-box">
									<div class="overlay-container">
										...
										<div class="overlay">
											<div class="overlay-links">
												<a href="portfolio-item.html"><i class="fa fa-link"></i></a>
												<a href="static/images/portfolio-5.jpg" class="popup-img"><i class="fa fa-search-plus"></i></a>
											</div>
										</div>
									</div>
									<div class="image-box-body">
								...
								<div class="image-box">
									<div class="overlay-container">
										...
										<div class="overlay">
											<div class="overlay-links">
												<a href="portfolio-item.html"><i class="fa fa-link"></i></a>
												<a href="static/images/portfolio-6.jpg" class="popup-img"><i class="fa fa-search-plus"></i></a>
											</div>
										</div>
									</div>
									<div class="image-box-body">
								...
								<div class="image-box">
									<div class="overlay-container">
										...
										<div class="overlay">
											<div class="overlay-links">
												<a href="portfolio-item.html"><i class="fa fa-link"></i></a>
												<a href="static/images/portfolio-7.jpg" class="popup-img"><i class="fa fa-search-plus"></i></a>
											</div>
										</div>
									</div>
									<div class="image-box-body">
								...
								<div class="image-box">
									<div class="overlay-container">
										...
										<div class="overlay">
											<div class="overlay-links">
												<a href="portfolio-item.html"><i class="fa fa-link"></i></a>
												<a href="static/images/portfolio-8.jpg" class="popup-img"><i class="fa fa-search-plus"></i></a>
											</div>
										</div>
									</div>
									<div class="image-box-body">
...
<!--
<h3 class="fancy-subtitle">EmprendeHub</h3>
<h2 class="title mb15 text-center  text-uppercasse">Sobre Nosotros</h2>
<p>Equipo de emprendores que asesoramos y desarrollamos ideas y proyectos, brindando soluciones tecnologicas.</p>
-->
