              ...
              <div class="tab-pane active" id="portfolio-images">
                <div class="owl-carousel content-slider-with-controls">
                  <div class="overlay-container">
                    <img src="static/images/portfolio-item-1.jpg" alt="">
                    <a href="static/images/portfolio-item-1.jpg" class="popup-img overlay" title="image title"><i class="fa fa-search-plus"></i></a>
                  </div>
                  <div class="overlay-container">
                    <img src="static/images/portfolio-item-2.jpg" alt="">
                    <a href="static/images/portfolio-item-2.jpg" class="popup-img overlay" title="image title"><i class="fa fa-search-plus"></i></a>
                  </div>
                  <div class="overlay-container">
                    <img src="static/images/portfolio-item-3.jpg" alt="">
                    <a href="static/images/portfolio-item-3.jpg" class="popup-img overlay" title="image title"><i class="fa fa-search-plus"></i></a>
                  </div>
                </div>
              </div>
        ...
        <div class="owl-carousel carousel">
          ...
          <div class="image-box object-non-visible" data-animation-effect="fadeInLeft" data-effect-delay="200">
            <div class="overlay-container">
              ...
              <a href="static/portfolio-item.html" class="overlay small">
                <i class="fa fa-link"></i>
                <span>Web Design</span>
              </a>
            </div>
