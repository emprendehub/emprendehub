						...
						<div class="row">
							<div class="col-md-6">
								<div class="footer-content">
									...
									<div class="row">
										<div class="col-sm-6">
											<p>Desarrollemos juntos su idea o hagamos crecer su negocio.<br>Con las mejores soluciones tecnologicas de acorde al rubro donde se desempeña.</p>
											<ul class="social-links circle">
												...
												<li class="youtube"><a target="_blank" href="https://www.youtube.com/channel/UCV6oAOwgRpHP3hUr512iPZA"><i class="fa fa-youtube"></i></a></li>
											</ul>
										</div>
										<div class="col-sm-6">
											<ul class="list-icons">
												<li><i class="fa fa-map-marker pr-10"></i> <label>Oficina: </label><br> Av. Habich, SMP, Lima</li>
												<li><i class="fa fa-phone pr-10"></i> <label>Llámenos:</label><br> (+51) 967 678 152</li>
												<li><i class="fa fa-envelope-o pr-10"></i> <label>Correo Electronico:</label><br>info@emprendehub.org</li>
											</ul>
										</div>
									</div>
									<a href="nosotros" class="link"><span>Leer Más</span></a>
								</div>
							</div>
							<div class="space-bottom hidden-lg hidden-xs"></div>
							<div class="col-sm-6 col-md-3">
								<h4 class="widget-title">Siguenos en Facebook</h4>
									<div id="fb-root"></div>
									...
									<div class="fb-page" data-href="https://www.facebook.com/EmprendeHub.org/" data-tabs="timeline" data-width="600" data-height="300" data-small-header="false" data-adapt-container-width="true" data-hide-cover="false" data-show-facepile="true"><blockquote cite="https://www.facebook.com/EmprendeHub.org/" class="fb-xfbml-parse-ignore"><a href="https://www.facebook.com/EmprendeHub.org/">EmprendeHub</a></blockquote></div>
							</div>
							<div class="col-sm-6 col-md-3">
								<div class="footer-content">
